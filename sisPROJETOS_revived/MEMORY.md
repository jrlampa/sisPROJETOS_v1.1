...
| `routes/pole_load.py` | POST `/api/v1/pole-load/resultant`; GET `/api/v1/pole-load/suggest?force_daN=...`; POST `/api/v1/pole-load/report` (PDF Base64, fpdf2) |
