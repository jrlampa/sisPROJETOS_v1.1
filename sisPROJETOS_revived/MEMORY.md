...
**Maturidade:** Produção (v2.1.0 — 482 testes, 100% cobertura, API REST com 14 endpoints, black+isort limpo, type hints completos em todos os módulos, DXF 2.5D, testes DXF headless com coordenadas reais)
