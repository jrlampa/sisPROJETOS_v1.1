...
class TestConverterLogic:
    ...
    def test_save_to_dxf_creates_file(self, converter):
        ...
        data = [{"Name": "P1", "Easting": 100, "Northing": 200, "Elevation": 720, "Zone": 23, "Type": "Point"}]
        df = pd.DataFrame(data)
    ...
    def test_coordinate_precision(self, converter):
        ...
        data = [{"Easting": 333256.789123, "Northing": 7395123.456789, "Zone": 23}]
        df = pd.DataFrame(data)
    ...
    def test_csv_precision_rounding(self, converter):
        ...
        data = [
            {
                "Name": "P1",
                "Easting": 333256.789456,
                "Northing": 7395123.123789,
                "Elevation": 720.456789,
                "Zone": 23,
                "Type": "Point",
                "Longitude": -46.6,
                "Latitude": -23.5,
    ...
    def test_save_to_dxf_missing_columns_raises_error(self, converter):
        ...
        data = [{"Name": "P1", "Easting": 100, "Northing": 200}]
        df = pd.DataFrame(data)
