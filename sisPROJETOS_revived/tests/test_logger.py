...
class TestFileLogging:
    ...
    def test_no_file_logging_when_disabled(self, tmp_path):
        ...
        logger = setup_logger("test_no_file", log_to_file=False, log_to_console=False)
...
class TestConsoleLogging:
    ...
    def test_console_logging_explicit(self):
        ...
        logger = setup_logger("test_console_explicit", log_to_file=False, log_to_console=True)
