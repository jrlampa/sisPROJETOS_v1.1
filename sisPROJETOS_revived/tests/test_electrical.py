...
class TestElectricalLogic:
    ...
    def test_calculate_voltage_drop_three_phase_valid(self, electrical):
        ...
        result = electrical.calculate_voltage_drop(
            power_kw=100, distance_m=200, voltage_v=380, material="Alumínio", section_mm2=50, cos_phi=0.92, phases=3
        )
    ...
    def test_calculate_voltage_drop_single_phase_valid(self, electrical):
        ...
        result = electrical.calculate_voltage_drop(
            power_kw=10, distance_m=50, voltage_v=220, material="Cobre", section_mm2=10, cos_phi=0.95, phases=1
        )
    ...
    def test_calculate_voltage_drop_within_limit(self, electrical):
        ...
        result = electrical.calculate_voltage_drop(
            power_kw=5, distance_m=10, voltage_v=380, material="Cobre", section_mm2=25, cos_phi=0.92, phases=3
        )
    ...
    def test_calculate_voltage_drop_exceeds_limit(self, electrical):
        ...
        result = electrical.calculate_voltage_drop(
            power_kw=500, distance_m=1000, voltage_v=220, material="Alumínio", section_mm2=4, cos_phi=0.85, phases=1
        )
    ...
    def test_calculate_voltage_drop_zero_section(self, electrical):
        ...
        result = electrical.calculate_voltage_drop(
            power_kw=100, distance_m=200, voltage_v=380, material="Alumínio", section_mm2=0, cos_phi=0.92, phases=3
        )
    ...
    def test_calculate_voltage_drop_zero_voltage(self, electrical):
        ...
        result = electrical.calculate_voltage_drop(
            power_kw=100, distance_m=200, voltage_v=0, material="Alumínio", section_mm2=50, cos_phi=0.92, phases=3
        )
    ...
    def test_calculate_voltage_drop_high_cos_phi(self, electrical):
        ...
        result = electrical.calculate_voltage_drop(
            power_kw=50, distance_m=100, voltage_v=380, material="Cobre", section_mm2=35, cos_phi=0.98, phases=3
        )
    ...
    def test_calculate_voltage_drop_low_cos_phi(self, electrical):
        ...
        result = electrical.calculate_voltage_drop(
            power_kw=50, distance_m=100, voltage_v=380, material="Alumínio", section_mm2=35, cos_phi=0.7, phases=3
        )
    ...
    def test_calculate_voltage_drop_invalid_cos_phi_zero(self, electrical):
        ...
        result = electrical.calculate_voltage_drop(
            power_kw=100, distance_m=200, voltage_v=380, material="Alumínio", section_mm2=50, cos_phi=0, phases=3
        )
        assert result is None
    ...
    def test_calculate_voltage_drop_invalid_cos_phi_above_one(self, electrical):
        ...
        result = electrical.calculate_voltage_drop(
            power_kw=100, distance_m=200, voltage_v=380, material="Alumínio", section_mm2=50, cos_phi=1.5, phases=3
        )
        assert result is None
    ...
    def test_calculate_voltage_drop_invalid_phases(self, electrical):
        ...
        result = electrical.calculate_voltage_drop(
            power_kw=100, distance_m=200, voltage_v=380, material="Alumínio", section_mm2=50, cos_phi=0.92, phases=2
        )
        assert result is None
