...
class TestCQTLogic:
    ...
    def test_calculate_branched_network_topology(self, cqt):
        ...
        segments = [
            {'ponto': 'TRAFO', 'montante': '', 'metros': 0, 'cabo': '2#16(25)mm² Al',
             'mono': 0, 'bi': 0, 'tri': 0, 'tri_esp': 0, 'carga_esp': 0},
            {'ponto': 'P1', 'montante': 'TRAFO', 'metros': 50, 'cabo': '3x35+54.6mm² Al',
             'mono': 5, 'bi': 0, 'tri': 0, 'tri_esp': 0, 'carga_esp': 0},
            {'ponto': 'P2', 'montante': 'P1', 'metros': 50, 'cabo': '3x35+54.6mm² Al',
             'mono': 3, 'bi': 0, 'tri': 0, 'tri_esp': 0, 'carga_esp': 0},
            {'ponto': 'P3', 'montante': 'P1', 'metros': 50, 'cabo': '3x35+54.6mm² Al',
             'mono': 2, 'bi': 0, 'tri': 0, 'tri_esp': 0, 'carga_esp': 0},
        ]
...
# ============================================================
# Testes de sanitização de entradas (calculate)
# ============================================================
