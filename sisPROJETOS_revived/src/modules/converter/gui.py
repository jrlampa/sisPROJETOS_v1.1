...
class ConverterGUI(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        # --- Sidebar / Controls ---
        self.side_panel = ctk.CTkFrame(self, width=320, fg_color="#F8FAFC", corner_radius=15, border_width=1, border_color="#E2E8F0")
        ...
        self.lbl_file = ctk.CTkLabel(self.side_panel, text="Nenhum arquivo ativo", font=DesignSystem.FONT_BODY, text_color=DesignSystem.TEXT_DIM, wraplength=250)
        ...
        self.btn_back = ctk.CTkButton(self.side_panel, text="Voltar ao Menu", command=lambda: self.controller.show_frame("Menu"), **DesignSystem.get_button_style("gray"))
        self.btn_back.pack(pady=30, side="bottom", padx=30, fill="x")

        # --- Map Panel ---
        self.map_container = ctk.CTkFrame(self, fg_color="white", corner_radius=15, border_width=1, border_color="#E2E8F0")
