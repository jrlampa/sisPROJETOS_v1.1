...
class ElectricalGUI(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        self.cmb_sec = self.create_combo(self.right_col, "Seção (mm²):", ["10", "16", "25", "35", "50", "70", "95", "120"], "16")
        self.cmb_phases = self.create_combo(self.right_col, "Fases:", ["3 (Trifásico)", "1 (Monofásico)"], "3 (Trifásico)")
        ...
        self.res_frame = ctk.CTkFrame(self, fg_color="#F8FAFC", corner_radius=15, border_width=1, border_color="#E2E8F0")
    ...
    def create_field(self, parent, label, default):
        ctk.CTkLabel(parent, text=label, font=DesignSystem.FONT_BODY, text_color=DesignSystem.TEXT_MAIN).pack(anchor="w", padx=10, pady=(10,0))
